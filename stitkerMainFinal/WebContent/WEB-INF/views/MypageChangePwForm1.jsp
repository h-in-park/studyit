    ...
    <div class="bg-dark col-12 title2">
        ...
        <div class="tab-content" id="myTabContent"><br>
          ...
          <div class="modifyform" id="Modifyinfo" >
          	<form action="changepasswordform2.action" method="post">
	            <table id="table1" class="table tablemi" style="width: 70%; margin: auto;">
					<tr>
						<th colspan="8" class="bg-light">비밀번호 확인</th>
					</tr>
					<tr>
						 <th colspan="4" class="bg-light">기존 비밀번호</th>
						 <td colspan="4">
						 	<input type="password" class="form-control" name="password" placeholder="기존 비밀번호를 입력해주세요"/>
						 </td>
						 <c:if test="${errMsg!=null }">
						 <tr>
						 	<td colspan="8" style="text-align: center;">
						 		<span style="font-size: 9pt; color: red;">${errMsg }</span>
						 	</td>
						 </tr>
						 </c:if>
					</tr>
					<tr>
						<th colspan="8" style="height: 33px;" class="bg-light">
							<button type="submit" class="btn btn-outline-primary btn-sm btnModify">확  인</button>
