...
<script type="text/javascript">
		...
		$(document).ready(function() {
			...
			$("#cancel").click(function()
			{
				...
				if(result)
				{
					location.replace("qnaboard_detail.action?post_code=" + $(this).val());
				}
			});
...
<div class="whole">
	...
	<div class="content">
		...
		<br>
		<form action="qnaboard_update.action" method="get" name="myForm" role="form" class="form-inline">
		...
		<div id="btnSet">
			...
			<button type="button" class="btn btn-outline-primary" id="cancel" value="${post.post_code }">취소하기</button>
		</div>
		</form>
